...
const TermsConditions = () => {
  ...
  const url = "https://codesandmarketing.com/";
  const brandName = "Beera Jwellers";


  return (
    <section className="my-5 py-14 px-[10%] mt-[10%]">
      ...
      <Para
        ...
        points={[
          ...
          <> vi. How and to whom <a className="text-blue-400" href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> will disclose such information"</>
        ]} />
      ...
      <Para
        heading={
          <>
            ...
            <a className="text-blue-400" href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}
            </a>
          </>
        }
      ...
      <Para
        points={[
          <>
            "i. We may collect personal information about you when you visit our website, including name, address, email address, phone numbers, information used to personalize, date of birth and other information. <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a>  uses this information to provide better service to you and to enable us to contact you if a problem arises.</>,

          <>ii. We may ask you for and collect personal information at other times, including when you avail the services of <a className="text-blue-400"   href={url} target="_blank" rel="noopener noreferrer">
            {brandName}</a> when you complete surveys on <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> when you participate in a user forum or blog hosted by <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> or one of/any of our business partners. We use the information you provide to help us provide you better services, to customize your experience on our website, and to provide advice and purchase recommendations and for other purposes consistent with this statement. <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> may also match user information with third party data to help us better understand our customers.</>,
          ...
          <> vi. Your session log information on our site which includes your navigation within the site, source of traffic, IP address (from which we can approximately determine user location), browser type, browser language, operating system, date and time of request, etc.
            vii. Identification code of your communication device with you use to access the website or otherwise deal with any <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> related entity;</>,

          <> viii. We also conducts research on its users’ demographics, interests, and behaviour based on the information provided to us when the user engages us for providing any services or simply visit our website. We do this to better understand and serve our users. This research is compiled and analysed on an aggregated basis so as to prevent identification of personal information relating to any one individual. <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> may share this aggregated data with our business partners/subsidiaries and not with any other unauthorised third party/entity.</>,
      ...
      <Para
        ...
        points={[
          <>i. You agree and acknowledge that you are providing your information out of your free will. You have option not to provide or permit <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> to collect. In such a case when you don’t want to share the data with <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a>, you should neither visit our website nor use any services provided by <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> nor shall contact <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a>. Further, you may cancel your registration at any time, and you can choose to opt-outof receiving any e-mails and/or sms messages from us by unsubscribing at our website.[Office2]</>,
      ...
      <Para
        heading={<> 6.YOU REPRESENT TO <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
          {brandName}</a> that</>}

        points={[
          <>i. The Information You provide to <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> from time to time is and shall be authentic, correct, current and updated and You have all the rights, permissions and consents as may be required to provide such Information to <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a>.</>,
          <>ii.Your providing the Information to <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a>  and <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> consequent storage, collection, usage, transfer, access or processing of the same shall not be in violation of any third party agreement, laws, charter documents, judgments, orders and decrees.</>,
          <>iii.<a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> and each of <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> entities officers, directors, contractors or agents shall not be responsible for the authenticity of the Information that You or any other user provide to <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a>. You shall indemnify and hold harmless <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> and each of <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> entities officers, directors, contracts or agents and any third party relying on the Information provided by You in the event You are in breach of this Privacy Policy including this provision and the immediately preceding provision above.</>,
      ...
      <Para
        ...
        points={[
          <>This Privacy Policy applies only to our website. <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> may provide links to other websites, which we believe, may be of interest to you. These companies may use information (not including your name, address, email address, or telephone number) but only about your visits to this and other websites in order to provide advertisements about gods and services of interest to you.</>,

          <>Our website links to other websites that may collect personally identifiable information about you. <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> is not responsible for any form of transmission, whatsoever, received by You from any third party website. Accordingly, </>,

          <><a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
            {brandName}</a> does not make any representations concerning the privacy practices or policies of such third parties or terms of use of such third party websites, nor does <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> control or guarantee the accuracy, integrity, or quality of the content available on such third party websites. The inclusion or exclusion does not imply any endorsement by <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
              {brandName}</a> of the third party websites, the website’s provider, or the information on the website. The information provided by You to such third party websites shall be governed in accordance with the privacy policies of such third party websites and it is recommended that You review the privacy policy of such third party websites prior to using such websites.</>
        ]}
      />
      ...
      <Para
        ...
        text={<> <a className="text-blue-400"   href={url}  target="_blank" rel="noopener noreferrer">
          {brandName}</a> reserves the right to amend this Privacy Policy without prior notice to reflect technological advancements, legal and regulatory changes and good business practices. If we change our privacy practices, a new Privacy Policy will reflect those changes and the effective date of the revised Privacy Policy will be set forth at the beginning of the new/amended Privacy Policy.</>}
      />
